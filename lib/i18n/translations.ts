...
export const translationsByLang = {
  de: {
    nav: {
      ...
      campaignExcel: "Kampagne Excel",
      campaignCsv: "Kampagne CSV",
    },
  ...
  en: {
    nav: {
      ...
      promoPreview: "Promotion preview",
  ...
  fr: {
    nav: {
      ...
      standardExcel: "Standard Excel",
      standardCsv: "Standard CSV",
      campaignExcel: "Campagne Excel",
      campaignCsv: "Campagne CSV",
    },
  ...
  it: {
    nav: {
      ...
      standardExcel: "Standard Excel",
      standardCsv: "Standard CSV",
      campaignExcel: "Campagna Excel",
      campaignCsv: "Campagna CSV",
    },
  ...
  rm: {
    nav: {
      ...
      promoPreview: "Prevista promo",
      priceList: "Glista da pretschs",
      priceLists: "Glistas da pretschs",
      standard: "Standard",
      campaign: "Campagna",
      standardExcel: "Standard Excel",
      standardCsv: "Standard CSV",
